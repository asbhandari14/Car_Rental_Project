...
const SaveBig = (props) => {
  return (
    <>
      <div className="savebig_section w-full h-[45vh] flex justify-center items-center bg-black text-white">
        <div className="container w-[80%] h-full flex flex-col justify-center items-center gap-5">
