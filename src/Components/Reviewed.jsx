...
const Reviewed = () => {
  return (
    <>
        ...
        <div className="review_section w-full h-auto flex justify-center items-center my-8">
            <div className="container w-[80%] h-auto flex flex-col justify-center items-center p-8 gap-4">
                ...
                <div className=" w-full h-auto grid grid-cols-2 text-xl font-semibold gap-8">
                  <div className=" w-full h-auto flex flex-col justify-start items-start p-12  shadow-lg">
