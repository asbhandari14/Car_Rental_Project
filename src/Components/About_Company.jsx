...
const About_Company = () => {
  return (
    <>
      <div className="About_company_section w-full h-auto flex justify-center items-center my-12">
        <div className="container w-[80%] h-auto grid grid-cols-2 py-4 gap-12">
            <div className='w-full h-full flex justify-end items-center '>
                <img src="../images/img9.jpg" width="80%" alt=""/>
            </div>
