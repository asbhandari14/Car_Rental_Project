    ...
    return(
        <>
            <div className="vehicle_model_section w-full h-auto flex justify-center items-center my-12">
                <div className="container w-[95%] h-auto grid grid-cols-3 place-items-center gap-[6_8]">
                    {
                        all_car_product.map((currElem)=>{
                            return(
                                <>
                                    <div className="w-full h-auto flex flex-col justify-center items-center px-5 py-2 shadow-xl">
                                        ...
                                        <div className="w-full flex justify-between items-start">
                                            ...
                                            <div className="price w-full flex flex-col justify-start items-start gap-3">
                                                <p>{currElem.price}</p>
                                                <p>per day</p>
                                                <p>{currElem.rating}</p>
                                                <p>{currElem.fuel}</p>
